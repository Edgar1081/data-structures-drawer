...
public abstract class ArbolBinario<T> implements Coleccion<T> {
    ...
    protected class Vertice implements VerticeArbolBinario<T> {
        ...
        private int altura(Vertice v){
            return v == null? -1: 1 + Math.max(altura(v.izquierdo), altura(v.derecho));
        }
        ...
        private boolean equals(Vertice v, Vertice u){
            ...
            if(v == null || u == null)
                return false;
            return v.elemento.equals(u.elemento) && equals(v.izquierdo, u.izquierdo) && equals(v.derecho, u.derecho);
        }
    ...
    public VerticeArbolBinario<T> busca(T elemento) {
        if (raiz == null)
            return null;
        Cola<VerticeArbolBinario<T>> c = new Cola<>();
        c.mete(raiz);
        while(!c.esVacia()){
    ...
    private String toString(VerticeArbolBinario<T> v, int l, int[] a) {
        String s = "";
        s += v.toString() + "\n";
        a[l] = 1;
